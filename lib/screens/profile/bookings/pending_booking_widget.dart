...
class PendingBookingWidget extends ConsumerStatefulWidget {
  const PendingBookingWidget({super.key});

  @override
  ConsumerState<PendingBookingWidget> createState() =>
      _PendingBookingWidgetState();
}

class _PendingBookingWidgetState extends ConsumerState<PendingBookingWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final pendingBookingsAsync = ref.watch(pendingBookingsProvider(userId));
    return pendingBookingsAsync.when(
      data: (bookingData) {
        if (bookingData.isEmpty) {
          return Center(child: Text("No Pending Booking"));
        }
