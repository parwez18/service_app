...
class BookingDetailedScreen extends StatefulWidget {
  ...
  const BookingDetailedScreen({super.key, required this.bookingData});
      ...
      child: Column(
        children: [
          ...
          widget.bookingData.status == 'rejected'
                      ...
                      child: Column(
                        children: [
                          _buildInfoRow(
                            Icons.payment,
                            'Refund',
                            "Refund will be reflect in your account within 24 hours",
                          ),
              ...
              : SizedBox.shrink(),
          // For OTP of Bookings
          widget.bookingData.status == 'ongoing'
              ? Padding(
                  padding: EdgeInsets.symmetric(horizontal: 15.w),
                  child: Card(
                    color: Colors.white,
