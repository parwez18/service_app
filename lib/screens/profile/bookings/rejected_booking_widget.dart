...
class RejectedBookingWidget extends ConsumerStatefulWidget {
  const RejectedBookingWidget({super.key});

  @override
  ConsumerState<RejectedBookingWidget> createState() =>
      _PendingBookingWidgetState();
}

class _PendingBookingWidgetState extends ConsumerState<RejectedBookingWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final rejectedBookingsAsync = ref.watch(rejectedBookingsProvider(userId));
