...
class UpcomingBookingWidget extends ConsumerStatefulWidget {
  const UpcomingBookingWidget({super.key});

  @override
  ConsumerState<UpcomingBookingWidget> createState() =>
      _PendingBookingWidgetState();
}

class _PendingBookingWidgetState extends ConsumerState<UpcomingBookingWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final upcomingBookingsAsync = ref.watch(upcomingBookingsProvider(userId));
