...
class TravelNearbyWidget extends ConsumerStatefulWidget {
  const TravelNearbyWidget({super.key});

  @override
  ConsumerState<TravelNearbyWidget> createState() => _TravelNearbyWidgetState();
}

class _TravelNearbyWidgetState extends ConsumerState<TravelNearbyWidget> {
  @override
  Widget build(BuildContext context) {
    final nearByServicesData = ref.watch(nearbyServicesProvider);
    ...
    return ListView.builder(
      shrinkWrap: true,
      itemCount: nearByServicesData.length,
      itemBuilder: (context, index) {
        var data = nearByServicesData[index];
          ...
          child: InkWell(
            onTap: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => ServiceDetailedPage(serviceData: data),
                ),
              );
            },
            borderRadius: BorderRadius.circular(12.r),
