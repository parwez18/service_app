...
class TravelWishlistWidget extends ConsumerWidget {
  final List<String> favouriteIds;
  const TravelWishlistWidget({super.key, required this.favouriteIds});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final favServices = ref.watch(favouriteServicesProvider(favouriteIds));
