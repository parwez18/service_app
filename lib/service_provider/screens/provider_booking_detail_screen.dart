...
class ProviderBookingDetailScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ProviderBookingDetailScreen> createState() =>
      _ProviderBookingDetailScreenState();
}

class _ProviderBookingDetailScreenState
    extends ConsumerState<ProviderBookingDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: bookingAsync.when(
        data: (booking) => _buildBookingContent(booking),
  ...
  Widget _buildBookingContent(BookingModel booking) {
    return SingleChildScrollView(
      child: Column(
        children: [
          // Header Card with Service Image
  ...
  Widget _buildCustomerCard(BookingModel booking) {
    return _buildCard(
      ...
      child: Column(
        children: [
          if (booking.userImage.isNotEmpty) ...[
            Center(
              child: CircleAvatar(
                radius: 40.r,
  ...
  Widget _buildServicesCard(BookingModel booking) {
    return _buildCard(
      icon: Icons.list_alt,
  ...
  Widget _buildLocationCard(BookingModel booking) {
    return _buildCard(
      icon: Icons.location_on_outlined,
      title: 'Service Location',
      child: Column(
        children: [
          _buildInfoRow(Icons.location_on, 'Address', booking.providerAddress),
          _buildInfoRow(Icons.phone, 'Contact', booking.providerPhone),
        ],
      ),
    );
  }
