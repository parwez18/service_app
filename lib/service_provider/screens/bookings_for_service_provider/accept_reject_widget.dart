...
class AcceptRejectWidget extends StatefulWidget {
  ...
  const AcceptRejectWidget({super.key, required this.bookingData});

  @override
  State<AcceptRejectWidget> createState() => _BookingDetailedScreenState();
}

class _BookingDetailedScreenState extends State<AcceptRejectWidget> {
