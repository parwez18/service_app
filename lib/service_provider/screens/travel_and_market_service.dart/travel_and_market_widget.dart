...
class TravelAndMarketWidget extends ConsumerStatefulWidget {
  const TravelAndMarketWidget({super.key});

  @override
  ConsumerState<TravelAndMarketWidget> createState() =>
      _TravelAndMarketWidgetState();
}

class _TravelAndMarketWidgetState extends ConsumerState<TravelAndMarketWidget> {
